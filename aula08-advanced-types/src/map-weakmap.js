...
const item1 = ['a','abacate'];

// weakmap só fica na memoria enquanto utilizado, dps é descartado
// ele não é iteravel e só funciona com a referencia do objeto como chave
...
console.log(weak.get(item1));
console.log(weak.has(item1));
